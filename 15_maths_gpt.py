...
prompt="""You are a calculator that takes a question and returns only the final arithmetic expression to evaluate. Do not explain.
Question:{question}
Expression:
"""
...
if "messages" not in st.session_state:
    st.session_state["messages"]=[
        {"role": "assistant", "content": "Hi, I'm a Mathematics chatbot who can answer all your maths questions."}
    ]
